...
#define _C_SX1276_H_
	...
	#error You have included an example
	...
	#define SX1276_nReset_TRIS		TRISDbits.TRISD0
	#define SX1276_nReset_LAT		LATDbits.LATD0

	#define SX1276_nCS_TRIS			TRISDbits.TRISD1
	#define SX1276_nCS_LAT			LATDbits.LATD1
